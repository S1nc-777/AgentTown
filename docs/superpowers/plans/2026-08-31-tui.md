...
function ctx(overrides: Partial<Parameters<typeof dispatchInput>[1]> = {}) {
  // params typed as any: the test asserts deep into nested action payloads
  // (params.action.payload.title), which Record<string, unknown> forbids.
...
async function makeProject(): Promise<string> {
  // writeFile never creates parent directories — mkdir .agenttown first.
